...
php ${consoleCmd} zikula:install:start -n --database_user=root --database_name=zikula --password=zikula --email=admin@example.com --router:request_context:host=localhost
