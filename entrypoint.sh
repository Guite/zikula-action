...
php ${consoleCmd} zikula:install:start -n --database_user=zikula --database_name=zk_test --password=zikula --email=admin@example.com --router:request_context:host=localhost
